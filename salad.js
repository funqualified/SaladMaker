...
function makeASalad(seed = '', rules = {
    base: 1,
    topping: 3,
    dressing: 1,
    excludedTags: []
...
let salad = makeASalad('Sarah');
console.log(salad.reduce((acc, ingredient) => acc + ingredient.name + ',\n', ''));